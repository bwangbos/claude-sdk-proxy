...
from quaylet.fallback_policy import RefusalFallback
from quaylet.model_catalog import backend_model
from quaylet.replay_stream import ReplayStream
from quaylet.session_identity import fixed_config_matches
from quaylet.thinking import ThinkingOptions

if TYPE_CHECKING:
    from quaylet.sessions import SessionRegistry
    from quaylet.tool_session_actor import ToolResponse, ToolSessionActor
...
class TurnLease:
    ...
    def __post_init__(self) -> None:
        self.response_headers = {
            "X-Quaylet-Session": self._conversation.external_id
        }
...
class ToolTurnLease:
    ...
    def __post_init__(self) -> None:
        self.response_headers = {"X-Quaylet-Session": self._actor.external_id}
    ...
    async def _active_stream(self) -> AsyncIterator[ConversationEvent]:
        from quaylet.tool_session_actor import STREAM_END, StreamFailure
