...
from quaylet.journal import BootstrapHead, Journal, UnconfirmedReason

ATTESTATION_MANIFEST_SCHEMA = "quaylet.child_attestation_manifest"
...
class SupervisorHandshakeReceipt:
    ...
    def _current_fingerprint(self) -> str:
        return _digest(
            b"quaylet:supervisor-handshake-receipt:v1",
            {
