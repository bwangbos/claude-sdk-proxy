...
from quaylet.diagnostics import record, record_backend_failure
...
from quaylet.sdk_metadata import (
    validate_fallback_notice,
    validate_rate_limit_event,
    validate_refusal_notice,
    validate_system_message,
)
from quaylet.sdk_text_protocol import (
    USAGE_FIELDS,
    fail_protocol,
    normalize_usage,
)
from quaylet.sdk_tool_protocol import RawSdkMessageValidator, RawToolCall
from quaylet.thinking import ThinkingOptions
from quaylet.tool_bridge import ToolBridge, ToolInvocation
from quaylet.tool_contract import (
    validate_tool_definitions,
    validate_tool_results,
)
from quaylet.tool_namespace import SDK_MCP_SERVER_NAME
...
class SdkSession:
    ...
    def _new_directory() -> TemporaryDirectory[str]:
        return TemporaryDirectory(prefix="quaylet-")
